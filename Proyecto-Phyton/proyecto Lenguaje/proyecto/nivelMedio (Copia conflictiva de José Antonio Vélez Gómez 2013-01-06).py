...
class Game:
    ...
    def update(self):
        ...
        if keys[K_LEFT]:
            ...
            if (self.sprite1.rect.left >= 130 and self.sprite1.rect.left <=150) and (self.sprite1.rect.top >= 470 and self.sprite1.rect.top <= 510):
    ...
    def draw(self):
        ...
        self.screen.blit(self.sprite1.imagen,self.sprite1.rect)
        self.screen.blit(self.puerta,(730,460))
        self.screen.blit(self.moneda,(130,470))
